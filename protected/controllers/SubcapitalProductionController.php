...
class SubcapitalProductionController extends Controller
{
	...
	{
		$invTypes = Invtypes::Model()->findAll('groupID IN (27)');
	...
	public function getComponentCount($typeID, $stationID)
	{
		...
		public function lastJitaPrice($typeID)
		{
			...
			$criteria->condition = ('typeID=:typeID AND (characterID = 0 OR characterID = 3) AND stationID = 60003760 AND transactionType = "buy"');
