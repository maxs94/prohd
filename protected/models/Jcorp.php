...
/**
 * This is the model class for table "jcorp".
 *
 * The followings are the available columns in table 'jcorp':
 ...
 */
class Jcorp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Jcorp the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('date, refID, refTypeID, ownerName1, ownerID1, ownerName2, ownerID2, argName1, argID1, corpID, amount, balance, reason, division', 'required'),
			array('amount, balance', 'numerical'),
			array('refID, corpID', 'length', 'max'=>20),
			array('refTypeID, ownerID1, ownerID2, argID1, division', 'length', 'max'=>10),
			array('ownerName1, ownerName2, argName1, reason', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('date, refID, refTypeID, ownerName1, ownerID1, ownerName2, ownerID2, argName1, argID1, corpID, amount, balance, reason, division', 'safe', 'on'=>'search'),
		);
	}
