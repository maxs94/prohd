...
/**
 * This is the model class for table "reftypes".
 *
 * The followings are the available columns in table 'reftypes':
 * @property string $refTypeID
 * @property string $refTypeName
 */
class Reftypes extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Reftypes the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('refTypeID, refTypeName', 'required'),
			array('refTypeID', 'length', 'max'=>10),
