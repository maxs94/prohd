...
$data1 = $this->getItemHistoricalData(24694);
$data2 = $this->getItemHistoricalData(645);
...
$this->Widget('ext.highcharts.HighchartsWidget', array(
   'options'=>array(
	  ...
	  'series' => array(
		 array('name' => 'Maelstrom', 'type'=>'line', 'data' => 'js:'.$data1),
		 array('name' => 'Dominix', 'type'=>'line', 'data' => 'js:'.$data2),
	  ),
