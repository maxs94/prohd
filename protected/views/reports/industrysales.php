...
$data1 = $this->getItemHistoricalData(22544);
$data2 = $this->getItemHistoricalData(2998);
...
$this->Widget('ext.highcharts.HighchartsWidget', array(
   'options'=>array(
	  ...
	  'series' => array(
		 array('name' => 'Hulk', 'type'=>'line', 'data' => 'js:'.$data1),
		 array('name' => 'Noctis', 'type'=>'line', 'data' => 'js:'.$data2),
